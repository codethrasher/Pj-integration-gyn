...
if (isset($_POST["update"])) {
    ...
    $update = "UPDATE Salle SET Salle = '$newSalle', Département = '$newDepartement', Catégorie = '$newCategorie', Responsable = '$newResponsable', Charge = $newCharge, Nb_place_examen = $newNbPlaceExamen, Nb_lignes = $newNbLignes, Nb_col = $newNbCol, Nb_surv = $newNbSurv, Type = '$newType', $newDisponible='newDisponible' WHERE Salle = '$oldSalle'";
